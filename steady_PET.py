...
def resolution(Ta, Tmrt, HR, v, age, sex, ht, mbody, pos, M, icl, Tx, p):
    Tn = fsolve(Syst,Tx ,args=(Ta, Tmrt, HR, v, age, sex, ht, mbody, pos, M, icl, True ,p))
    return (Tn, 1)
...
def fc_steady_PET(Ta,Tmrt,HR,v,icl,p):
    ...
    # compute PET
    PET = fc_PET(age, sex, ht, mbody, pos, M, icl, Tstable,p)
    return PET
